    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          ...
          onClick={onClose}
          className="fixed inset-0 bg-zinc-950/60 dark:bg-black/80 backdrop-blur-md cursor-pointer"
        />
        ...
        >
          ...
          <div className="relative w-full h-48 sm:h-56 bg-zinc-100 dark:bg-zinc-800/80 border-b border-zinc-200 dark:border-zinc-800 flex flex-col items-center justify-center overflow-hidden shrink-0">
          ...
          {/* Body Content - Scrollable with Lenis prevention & smooth scroll */}
          <div
            data-lenis-prevent="true"
